 ...
 */
public class ValidDatesInTimeValidator implements ConstraintValidator<ValidDatesInTime, BusyFlightsSearchDTO> {
    ...
    @Override
    public boolean isValid(BusyFlightsSearchDTO json, ConstraintValidatorContext constraintValidatorContext) {
        try {
